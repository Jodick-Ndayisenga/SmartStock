...
//   const now = new Date(); // This is always the current date/time
...
//   switch (dateRange) {
//     case 'today': {
//       // Today from 00:00:00 to 23:59:59 UTC
...
//   console.log('Filtering with timestamps:', {
//     startTimestamp,
//     endTimestamp,
...
//   return transactions
//     .filter(t => {
//       // t.transactionDate is already a timestamp (number)
//       const matches = t.transactionDate >= startTimestamp && t.transactionDate <= endTimestamp;
      
//       // Debug first few transactions
//       if (transactions.indexOf(t) < 5) {
//         console.log('Transaction check:', {
//           id: t.id,
//           txTimestamp: t.transactionDate,
//           txDate: new Date(t.transactionDate).toISOString(),
//           matches,
//           startTimestamp,
//           endTimestamp
//         });
...
//     })
//       .map(t => {
//         // Get contact name (you'd fetch from contacts table)
//         console.log(t.createdAt)
//         const contactName = t.contactId ? 'Customer Name' : undefined;
...
//   }, [transactions, payments, accounts, categories, dateRange]);
...
//     }
//   };
// // Also add debug in sections
// const sections = useMemo((): TransactionSection[] => {
//   //console.log(`Creating sections from ${filteredTransactions.length} transactions`);
...
//     .map(([date, items]) => {
//       //console.log(`Section ${date}: ${items.length} items`);
//       return {
//         title: date,
//         data: items,
//       };
